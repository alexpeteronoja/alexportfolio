      ...
      <div id="project-section">
        ...
        <div className=" mx-auto w-max grid md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-7">
          {ProjectData.map((item, index) => (
            <div
              key={index}
              className="w-[18.438rem] lg:w-[300px] shadow-xl shadow-slate-700 pb-7 rounded-2xl bg-gray-900 flex flex-col h-full"
            >
              <div>
                <img
                  className="w-[18.438rem] lg:w-[300px] rounded-t-2xl"
                  src={item.img}
                  alt=""
                />{' '}
              </div>
